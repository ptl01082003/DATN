    ...
    return ( <
        ...
        autoplaySpeed = { 2000 } >
        {
            lstProducts ? .map((product) => ( <
                ...
                /> <
                /div> <
                h3 className = "text-white mb-1 text-lg min-h-[3.5rem] line-clamp-2" > { product ? .name } <
                /h3> <
        ...
        autoplaySpeed = { 2000 } >
        {
            lstProducts ? .map((product, idx) => ( <
                ...
                div className = "p-4" >
                <
                h3 className = " mb-1 text-lg min-h-[3.5rem] line-clamp-2" > { product ? .name } <
                /h3> <
                ...
                >
                <
                h1 className = "text-center absolute top-[10%] right-1/2 text-white font-bold translate-x-1/2" > { idx + 1 } <
                /h1> <
                /div> <
                /div> <
                /div>
